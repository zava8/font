...
//
user_pref("font.name.monospace.x-unicode", "hin58m");
user_pref("font.name.monospace.x-western", "hin58m");
user_pref("font.name.sans-serif.x-unicode", "hin58");
user_pref("font.name.sans-serif.x-western", "hin58");
user_pref("font.name.serif.x-unicode", "hin58");
user_pref("font.name.serif.x-western", "hin58");
//
