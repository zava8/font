...
############################
echo "moving .ttf files from fontdrum to 5*/ now:"
read -n1 -rsp $'Press any key to continue or Ctrl+C to exit...\n'
############################
mv -f daunlod/fontdrum/*5.ttf daunlod/5/ && ( cd daunlod/5/ && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*54.ttf daunlod/5/54/ && ( cd daunlod/5/54 && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*8.ttf daunlod/5/8/ && ( cd daunlod/5/8 && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*84.ttf daunlod/5/84/ && ( cd daunlod/5/84 && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*5m.ttf daunlod/5m/ && ( cd daunlod/5m/ && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*54m.ttf daunlod/5m/54m/ && ( cd daunlod/5m/54m && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*8m.ttf daunlod/5m/8m/ && ( cd daunlod/5m/8m && pwd && ls *.ttf)
mv -f daunlod/fontdrum/*84m.ttf daunlod/5m/8m/84m/ && ( cd daunlod/5m/8m/84m/ && pwd && ls *.ttf)
( cd daunlod/fontdrum && pwd && ls *.ttf)
############################
echo "removing αll .ttf files from fontdrum now:"
read -n1 -rsp $'Press any key to continue or Ctrl+C to exit...\n'
############################
rm -i daunlod/fontdrum/*.ttf && ( cd daunlod/fontdrum && pwd && ls *.ttf)
############################
echo "moving αll woff2 files from fontdrum now:"
read -n1 -rsp $'Press any key to continue or Ctrl+C to exit...\n'
############################
...
############################
echo "removing αll .woff2 files from fontdrum now:"
read -n1 -rsp $'Press any key to continue or Ctrl+C to exit...\n'
############################
